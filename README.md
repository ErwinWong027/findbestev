...
**项目类型**: AI 售前咨询系统 | **角色**: 全栈开发

为企业客户打造的新能源汽车智能推荐平台，集成 Dify AI Agent 实现 7×24 小时自动化售前咨询。

### 核心职责与成果

| 模块 | 实现内容 | 业务价值 |
|------|----------|----------|
| **AI 对话集成** | iframe 嵌入 Dify Chatbot，支持语音输入 | 替代 80% 常见售前咨询 |
| **响应式落地页** | 5 大板块（Hero/Features/About/Testimonials/Footer）| 完美适配多端 |
| **动态视觉** | Paper Design Shader 脉冲动画背景 | 提升页面视觉吸引力 |
| **组件化架构** | 基于 shadcn/ui 封装可复用组件库 | 开发效率提升 50% |

### 技术亮点
- **零后端成本**: 纯前端 + Dify SaaS，无需维护 AI 服务
- **快速交付**: 从 0 到上线仅需 3 天
- **可复用架构**: 模块化设计，可快速迁移至其他行业（房产/保险等）
